...
<div  class={`${isSidebarOpen ? '' : '-ml-64'} sm:w-32 flex-shrink-0 md:w-64 flex flex-col border-r transition-all bg-gray-900 duration-300 min-h-full  grow`}> 
  <nav class="text-white">
    <div class="mt-6">
     ...
     <ul class={`space-y-1 ${isSubMenuOpen && index === 1 ? 'h-auto' : 'h-0 hidden' } mt-2 px-2 transition-all duration-500`}>
          <li>
            <a href="#" class="text-gray-400 font-bold hover:text-black transition-all text-sm flex items-center hover:bg-gray-400 rounded-md px-4 py-2">Sub Link</a>
          </li>
          <li>
            <a href="#" class="text-gray-400 font-bold hover:text-black transition-all text-sm flex items-center hover:bg-gray-400 rounded-md px-4 py-2">Sub Link</a>
          </li>
    ...
    <div class="mt-6">
        ...
        <ul class={`space-y-1 ${isSubMenuOpen && index === 2 ? 'h-auto' : 'h-0 hidden' } mt-2 px-2 transition-all duration-500`}>
             <li>
               <a href="/users" class="text-gray-400 font-bold hover:text-black transition-all text-sm flex items-center hover:bg-gray-400 rounded-md px-4 py-2">users table</a>
             </li>
             <li>
               <a href="/products" class="text-gray-400 font-bold hover:text-black transition-all text-sm flex items-center hover:bg-gray-400 rounded-md px-4 py-2">products</a>
             </li>
             <li>
               <a href="#" class="text-gray-400 font-bold hover:text-black transition-all text-sm flex items-center hover:bg-gray-400 rounded-md px-4 py-2">Sub Link</a>
             </li>
       ...
       <div class="mt-6">
        ...
        <ul class={`space-y-1 ${isSubMenuOpen && index === 3  ? 'h-auto' : 'h-0 hidden' } mt-2 px-2 transition-all duration-500`}>
             <li>
               <a href="#" class="text-gray-400 hover:text-black transition-all text-sm font-bold flex items-center hover:bg-gray-400 rounded-md px-4 py-2">Sub Link</a>
             </li>
             <li>
               <a href="#" class="text-gray-400 hover:text-black transition-all text-sm font-bold flex items-center hover:bg-gray-400 rounded-md px-4 py-2">Sub Link</a>
             </li>
